...
final List<ModelSpec> builtInSpecs = [
  ...
  ModelSpec(
    ...
    platformArtifacts: _runtimeArtifacts(
      ...
      coremlArtifact: 'qwen3_5_0_8b_decode_int4_mseq128.mlpackage',
  ...
  ModelSpec(
    ...
    platformArtifacts: {
      ...
      RuntimeEngine.coreml: RuntimeArtifact(
        ...
        path: 'pipeline.json',
        format: 'coreml-paddleocr-vl-pipeline',
        sourceUri: 'https://superplanner.ai/mise/models/manifest.json',
        ...
        metadata: const {
          ...
          'coremlStage': 'vision_embed',
          'mlxDecoderSubdir': 'mlx_decoder',
  ...
  ModelSpec(
    ...
    description: 'Qwen3.6 27B vision-language publish-time MLX benchmark model',
    requiredFiles: const ['config.json'],
    requiredTags: const ['mlx'],
    ...
    platformArtifacts: _runtimeArtifacts(
      ...
      mlxRepo: 'unsloth/Qwen3.6-27B-UD-MLX-4bit',
      mlxArtifact: '.',
    ),
  ),
  ModelSpec(
