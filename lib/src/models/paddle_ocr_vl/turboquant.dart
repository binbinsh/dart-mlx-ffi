...
bool get _turboDisableFastValuePath {
  ...
  final override =
      Platform.environment['DART_INFERENCE_PADDLE_TURBO_DISABLE_FAST_VALUE'];
...
bool get _turboDisableFastScorePath {
  ...
  if (debug != null) return debug;
  final override =
      Platform.environment['DART_INFERENCE_PADDLE_TURBO_DISABLE_FAST_SCORE'];
  if (override == null) return false;
  return override == '1' || override.toLowerCase() == 'true';
}
...
bool get _turboDisableFusedKvPath {
  ...
  if (debug != null) return debug;
  final override =
      Platform.environment['DART_INFERENCE_PADDLE_TURBO_DISABLE_FUSED_KV'];
  if (override == null) return false;
  return override == '1' || override.toLowerCase() == 'true';
}
...
bool get _turboDisableFusedDecodePath {
  ...
  if (debug != null) return debug;
  final override =
      Platform.environment['DART_INFERENCE_PADDLE_TURBO_DISABLE_FUSED_DECODE'];
  if (override == null) return false;
  return override == '1' || override.toLowerCase() == 'true';
}
...
bool get _turboDisableSingleTokenQuantizePath {
  ...
  if (debug != null) return debug;
  final override =
      Platform.environment['DART_INFERENCE_PADDLE_TURBO_DISABLE_SINGLE_QUANT'];
  if (override == null) return false;
  return override == '1' || override.toLowerCase() == 'true';
}

bool get _turboCompactDebug {
  final override = Platform.environment['DART_INFERENCE_PADDLE_TURBO_COMPACT_DEBUG'];
  if (override == null) return false;
  return override == '1' || override.toLowerCase() == 'true';
}
...
bool get _turboUpdateTrace {
  ...
  if (debug != null) return debug;
  final override = Platform.environment['DART_INFERENCE_PADDLE_TURBO_UPDATE_TRACE'];
  if (override == null) return false;
  return override == '1' || override.toLowerCase() == 'true';
}
...
bool get _turboDequantKvToQueryDTypePath {
  ...
  if (debug != null) return debug;
  final override =
      Platform.environment['DART_INFERENCE_PADDLE_TURBO_DEQUANT_KV_TO_QUERY_DTYPE'];
  if (override != null) {
    return override == '1' || override.toLowerCase() == 'true';
  }
...
bool get _turboDetachStateEachUpdate {
  ...
  if (debug != null) return debug;
  final override =
      Platform.environment['DART_INFERENCE_PADDLE_TURBO_DETACH_STATE_EACH_UPDATE'];
  if (override == null) return false;
  return override == '1' || override.toLowerCase() == 'true';
}
