...
extension PaddleOcrVlConfigRuntime on PaddleOcrVlConfig {
  ...
  int get recommendedVisionAttentionChunkSizeForCurrentPlatform {
    ...
    final override =
        Platform.environment['DART_INFERENCE_PADDLE_VISION_ATTENTION_CHUNK'];
    if (override != null) {
      final parsed = int.tryParse(override);
  ...
  bool get enableVisionLayerwiseEvalForCurrentPlatform {
    final override = Platform.environment['DART_INFERENCE_PADDLE_VISION_LAYER_EVAL'];
    if (override != null) {
  ...
  int get recommendedMemoryLimitBytesForCurrentPlatform {
    final override = Platform.environment['DART_INFERENCE_PADDLE_MEMORY_LIMIT_MB'];
    if (override != null) {
      final parsed = int.tryParse(override);
  ...
  int get recommendedWiredLimitBytesForCurrentPlatform {
    final override = Platform.environment['DART_INFERENCE_PADDLE_WIRED_LIMIT_MB'];
    if (override != null) {
      final parsed = int.tryParse(override);
      if (parsed != null) return parsed * 1024 * 1024;
    }
  ...
  int get recommendedCacheLimitBytesForCurrentPlatform {
    final override = Platform.environment['DART_INFERENCE_PADDLE_CACHE_LIMIT_MB'];
    if (override != null) {
      final parsed = int.tryParse(override);
      if (parsed != null) return parsed * 1024 * 1024;
    }
  ...
  int get visionEvalBatchSizeForCurrentPlatform {
    final override = Platform.environment['DART_INFERENCE_PADDLE_VISION_EVAL_BATCH'];
    if (override != null) {
      final parsed = int.tryParse(override);
      if (parsed != null && parsed > 0) return parsed;
    }
  ...
  int get visionMlpChunkSizeForCurrentPlatform {
    ...
    if (debug != null) return debug;
    final override = Platform.environment['DART_INFERENCE_PADDLE_VISION_MLP_CHUNK'];
    if (override != null) {
      final parsed = int.tryParse(override);
      if (parsed != null) return parsed;
    }
  ...
  int get visionProjectorChunkSizeForCurrentPlatform {
    ...
    if (debug != null) return debug;
    final override =
        Platform.environment['DART_INFERENCE_PADDLE_VISION_PROJECTOR_CHUNK'];
    if (override != null) {
      final parsed = int.tryParse(override);
      if (parsed != null) return parsed;
    }
  ...
  int get prefillChunkSizeForCurrentPlatform {
    ...
    if (debug != null) return debug;
    final override = Platform.environment['DART_INFERENCE_PADDLE_PREFILL_CHUNK'];
    if (override != null) {
      final parsed = int.tryParse(override);
      if (parsed != null) return parsed;
    }
  ...
  bool get enableDecodeCacheStateEvalForCurrentPlatform {
    final override =
        Platform.environment['DART_INFERENCE_PADDLE_DECODE_CACHE_STATE_EVAL'];
    if (override != null) {
      return override == '1' || override.toLowerCase() == 'true';
    }
    return Platform.isIOS;
  ...
  int get decodeCacheStateEvalIntervalForCurrentPlatform {
    ...
    final override =
        Platform.environment['DART_INFERENCE_PADDLE_DECODE_CACHE_EVAL_INTERVAL'];
    if (override != null) {
      final parsed = int.tryParse(override);
      if (parsed != null && parsed > 0) return parsed;
    }
  ...
  int get kvCacheQuantBitsForCurrentPlatform {
    ...
    final override = Platform.environment['DART_INFERENCE_PADDLE_KV_BITS'];
    if (override != null) {
      final parsed = int.tryParse(override);
      if (parsed != null) return parsed;
    }
  ...
  int get kvCacheQuantGroupSizeForCurrentPlatform {
    final override = Platform.environment['DART_INFERENCE_PADDLE_KV_GROUP_SIZE'];
    if (override != null) {
      final parsed = int.tryParse(override);
      if (parsed != null && parsed > 0) return parsed;
    }
  ...
  int get kvCacheQuantizedStartForCurrentPlatform {
    ...
    final override = Platform.environment['DART_INFERENCE_PADDLE_KV_QUANT_START'];
    if (override != null) {
      final parsed = int.tryParse(override);
      if (parsed != null) return parsed;
    }
  ...
  String get kvCacheQuantSchemeForCurrentPlatform {
    ...
    final override = Platform.environment['DART_INFERENCE_PADDLE_KV_QUANT_SCHEME'];
    if (override != null) {
  ...
  double? get turboQuantBitsForCurrentPlatform {
    ...
    final override =
        Platform.environment['DART_INFERENCE_PADDLE_TURBO_BITS'] ??
        Platform.environment['DART_INFERENCE_PADDLE_KV_BITS'];
    if (override != null) {
  ...
  int get turboQuantizedStartForCurrentPlatform {
    ...
    if (debug != null) return debug;
    final override = Platform.environment['DART_INFERENCE_PADDLE_TURBO_START'];
    if (override != null) {
      final parsed = int.tryParse(override);
      if (parsed != null) return parsed;
    }
  ...
  bool get turboDensePrefillForCurrentPlatform {
    ...
    if (debug != null) return debug;
    final override =
        Platform.environment['DART_INFERENCE_PADDLE_TURBO_DENSE_PREFILL'];
  ...
  int get turboCompactBudgetForCurrentPlatform {
    ...
    if (debug != null) return debug;
    final override =
        Platform.environment['DART_INFERENCE_PADDLE_TURBO_COMPACT_BUDGET'];
    if (override != null) {
      final parsed = int.tryParse(override);
      if (parsed != null) return parsed;
    }
  ...
  int get turboCompactKeepRecentForCurrentPlatform {
    ...
    if (debug != null) return debug;
    final override =
        Platform.environment['DART_INFERENCE_PADDLE_TURBO_COMPACT_KEEP_RECENT'];
    if (override != null) {
      final parsed = int.tryParse(override);
      if (parsed != null) return parsed;
    }
  ...
  int get turboCompactIntervalForCurrentPlatform {
    ...
    if (debug != null) return debug;
    final override =
        Platform.environment['DART_INFERENCE_PADDLE_TURBO_COMPACT_INTERVAL'];
    if (override != null) {
      final parsed = int.tryParse(override);
      if (parsed != null) return parsed;
    }
  ...
  int get turboCompactKeepPrefixForCurrentPlatform {
    ...
    if (debug != null) return debug;
    final override =
        Platform.environment['DART_INFERENCE_PADDLE_TURBO_COMPACT_KEEP_PREFIX'];
    if (override != null) {
      final parsed = int.tryParse(override);
      if (parsed != null) return parsed;
    }
  ...
  int get turboCompactHysteresisForCurrentPlatform {
    ...
    if (debug != null) return debug;
    final override =
        Platform.environment['DART_INFERENCE_PADDLE_TURBO_COMPACT_HYSTERESIS'];
    if (override != null) {
      final parsed = int.tryParse(override);
      if (parsed != null) return parsed;
    }
  ...
  bool get uniformQuantizedPrefillForCurrentPlatform {
    ...
    if (debug != null) return debug;
    final override =
        Platform.environment['DART_INFERENCE_PADDLE_UNIFORM_QUANTIZED_PREFILL'];
  ...
  int get maxKvCacheSeqLenForCurrentPlatform {
    final override =
        Platform.environment['DART_INFERENCE_PADDLE_MAX_KV_CACHE_SEQ_LEN'];
    if (override != null) {
      final parsed = int.tryParse(override);
      if (parsed != null && parsed > 0) return parsed;
    }
  ...
  int get turboCapacityStepForCurrentPlatform {
    ...
    final override =
        Platform.environment['DART_INFERENCE_PADDLE_TURBO_CAPACITY_STEP'];
    if (override != null) {
      final parsed = int.tryParse(override);
      if (parsed != null && parsed > 0) return parsed;
    }
  ...
  bool get enableVisionWeightReleaseForCurrentPlatform {
    final override =
        Platform.environment['DART_INFERENCE_PADDLE_RELEASE_VISION_WEIGHTS'];
    if (override != null) {
      return override == '1' || override.toLowerCase() == 'true';
    }
    return Platform.isIOS;
