...
extension PaddleOcrVlConfigDebug on PaddleOcrVlConfig {
  bool get enableDecoderLayerwiseEvalForCurrentPlatform {
    ...
    final override = Platform.environment['DART_INFERENCE_PADDLE_DECODER_LAYER_EVAL'];
    if (override != null) {
  ...
  bool get enableDecoderPerLayerTraceForCurrentPlatform {
    ...
    if (debug != null) return debug;
    final override =
        Platform.environment['DART_INFERENCE_PADDLE_TRACE_DECODER_LAYERS'];
    if (override != null) {
      return override == '1' || override.toLowerCase() == 'true';
    }
    return false;
  ...
  int get decoderPerLayerTraceIntervalForCurrentPlatform {
    ...
    final override =
        Platform.environment['DART_INFERENCE_PADDLE_TRACE_DECODER_INTERVAL'];
    if (override != null) {
  ...
  bool get enableDecoderSubstepTraceForCurrentPlatform {
    ...
    if (debug != null) return debug;
    final override =
        Platform.environment['DART_INFERENCE_PADDLE_TRACE_DECODER_SUBSTEPS'];
    if (override != null) {
      return override == '1' || override.toLowerCase() == 'true';
    }
    return false;
  ...
  int get decoderSubstepTraceLayerForCurrentPlatform {
    ...
    if (debug != null) return debug;
    final override =
        Platform.environment['DART_INFERENCE_PADDLE_TRACE_DECODER_SUBSTEP_LAYER'];
    if (override != null) {
      final parsed = int.tryParse(override);
  ...
  bool get enableDecoderTailTraceForCurrentPlatform {
    ...
    if (debug != null) return debug;
    final override = Platform.environment['DART_INFERENCE_PADDLE_TRACE_DECODER_TAIL'];
    if (override != null) {
      return override == '1' || override.toLowerCase() == 'true';
    }
    return false;
  ...
  bool get enableExplicitLogitsEvalForCurrentPlatform {
    ...
    if (debug != null) return debug;
    final override =
        Platform.environment['DART_INFERENCE_PADDLE_EXPLICIT_LOGITS_EVAL'];
    if (override != null) {
      return override == '1' || override.toLowerCase() == 'true';
    }
    return true;
  ...
  bool get forceDecodeLmHeadFloat32ForCurrentPlatform {
    ...
    if (debug != null) return debug;
    final override =
        Platform.environment['DART_INFERENCE_PADDLE_FORCE_DECODE_LM_HEAD_F32'];
    if (override != null) {
      return override == '1' || override.toLowerCase() == 'true';
    }
    return Platform.isIOS;
  ...
  bool get enableClearAfterCloseLogitsForCurrentPlatform {
    ...
    if (debug != null) return debug;
    final override =
        Platform.environment['DART_INFERENCE_PADDLE_CLEAR_AFTER_CLOSE_LOGITS'];
    if (override != null) {
      return override == '1' || override.toLowerCase() == 'true';
    }
    if (Platform.isIOS) {
  ...
  bool get enableForceGpuSynchronizePerTokenForCurrentPlatform {
    ...
    if (debug != null) return debug;
    final override = Platform.environment['DART_INFERENCE_PADDLE_SYNC_EACH_TOKEN'];
    if (override != null) {
      return override == '1' || override.toLowerCase() == 'true';
    }
    return false;
  ...
  bool get enableDecoderHiddenDetachForCurrentPlatform {
    ...
    if (debug != null) return debug;
    final override =
        Platform.environment['DART_INFERENCE_PADDLE_DECODER_HIDDEN_DETACH'];
    if (override != null) {
      return override == '1' || override.toLowerCase() == 'true';
    }
    if (Platform.isIOS) {
  ...
  bool get enableForceGpuSynchronizeAfterLayerEvalForCurrentPlatform {
    ...
    if (debug != null) return debug;
    final override =
        Platform.environment['DART_INFERENCE_PADDLE_SYNC_AFTER_LAYER_EVAL'];
    if (override != null) {
      return override == '1' || override.toLowerCase() == 'true';
    }
    return false;
  ...
  bool get enableDecodeLogitsDetachForCurrentPlatform {
    ...
    if (debug != null) return debug;
    final override =
        Platform.environment['DART_INFERENCE_PADDLE_DECODE_LOGITS_DETACH'];
    if (override != null) {
      return override == '1' || override.toLowerCase() == 'true';
    }
    if (Platform.isIOS) {
  ...
  bool get enableAggressiveCacheClearingForCurrentPlatform {
    ...
    if (debug != null) return debug;
    final override = Platform.environment['DART_INFERENCE_PADDLE_CLEAR_CACHE'];
    if (override != null) {
      return override == '1' || override.toLowerCase() == 'true';
    }
    if (Platform.isIOS && kvCacheQuantSchemeForCurrentPlatform == 'turboquant') {
  ...
  bool get forceFloat32VisionForCurrentPlatform {
    final override = Platform.environment['DART_INFERENCE_PADDLE_FORCE_VISION_F32'];
    if (override != null) {
      return override == '1' || override.toLowerCase() == 'true';
    }
    return false;
