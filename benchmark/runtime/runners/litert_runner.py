...
def main() -> None:
    ...
    if args.delegate:
        cmd.extend(["--delegate", args.delegate])
    if args.litert_section_index:
        cmd.extend(["--litert-section-index", args.litert_section_index])
    if args.require_delegate:
