...
from make_private_blocks import API_URL, CONFIG_URL, LOCAL_CONFIG, build_specs, emit_block, fetch_json_with_fallback
...
def main() -> None:
    ...
    work_dir = Path(tempfile.mkdtemp(prefix="josie_private_"))
    try:
        ...
        print("josie private ane benchmark")
