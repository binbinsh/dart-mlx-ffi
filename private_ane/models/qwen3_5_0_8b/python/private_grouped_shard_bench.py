...
def main() -> None:
    ...
    work_dir = Path(tempfile.mkdtemp(prefix="qwen35_private_ane_grouped_"))
    try:
        ...
        proc = subprocess.run(
            [
                "dart",
                "run",
                "tool/qwen35_private_ane_grouped_shard_bench.dart",
                "--snapshot-dir",
                str(snapshot_dir),
                "--artifacts-dir",
                str(artifacts_dir),
        ...
        report["grouped_shard_size"] = args.grouped_shard_size
